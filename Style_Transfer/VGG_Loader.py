""" Load weights of a pre-trained VGGNet for the implementation
...
class VGG(object):
    ...
    def _weights(self, layer_idx, expected_layer_name):
        """ Pick the weights and biases at layer_idex already 
        trained by VGG
        """
    ...
    def conv2d_relu(self, prev_layer, layer_idx, layer_name):
        """ Construct the conv2D layer with RELU using the weights,
    ...
    def avgpool(self, prev_layer, layer_name):
        ...
        average pooling works better than max pooling. Sure?
        """
